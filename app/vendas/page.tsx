...
export default function VendasPage(){
  return (
    <main style={{minHeight:"100vh",background:"#f7f8fa",color:"#172033",fontFamily:"Inter,Arial,sans-serif"}}>
      <header style={{background:"#fff",borderBottom:"1px solid #e6e9ee"}}>
      ...
      <section style={{maxWidth:1120,margin:"auto",padding:"76px 22px 70px",display:"grid",gridTemplateColumns:"1.15fr .85fr",gap:42,alignItems:"center"}}>
        <div>
          ...
          <div style={{display:"flex",gap:12,flexWrap:"wrap",marginTop:28}}>
            <a href="#plano" style={{background:"#f5b942",color:"#172033",textDecoration:"none",padding:"14px 22px",borderRadius:9,fontWeight:900}}>Conhecer o plano →</a>
          ...
          <p style={{fontSize:13,color:"#7b8794",marginTop:15}}>14 dias de teste • Gestão simples • Acesso online</p>
        </div>
        ...
        <div style={{maxWidth:1120,margin:"auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16}}>
            {features.map(([icon,title,description])=>(
              <article key={title} style={{border:"1px solid #e5e9ef",borderRadius:14,padding:22}}>
      ...
      <section id="plano" style={{maxWidth:760,margin:"auto",padding:"70px 22px"}}>
        <div style={{textAlign:"center",marginBottom:28}}>
          ...
          <p style={{color:"#667085"}}>Tudo que sua oficina precisa para começar.</p>
        </div>
        <article style={{background:"#fff",border:"2px solid #f5b942",borderRadius:20,padding:32,boxShadow:"0 15px 40px rgba(23,32,51,.08)"}}>
          ...
          <div style={{display:"flex",alignItems:"baseline",gap:6,margin:"8px 0 4px"}}>
            <span style={{fontSize:48,fontWeight:900}}>R$ 29,99</span><span style={{color:"#667085"}}>/mês</span>
          </div>
          <p style={{color:"#667085",lineHeight:1.5}}>Uma solução prática para organizar a gestão da sua oficina.</p>
      ...
      <style>{`@media(max-width:850px){main section{grid-template-columns:1fr!important}.featureGrid{grid-template-columns:1fr!important}}`}</style>
    </main>
  );
}
